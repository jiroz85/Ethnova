...
export default async function ProductPage({
  ...
  return (
    <div className="mx-auto w-full max-w-3xl px-6 py-10">
      ...
      <div className="mt-4 rounded-2xl border border-black/10 bg-white p-6 dark:bg-black dark:border-white/10">
        ...
        <div className="mt-6 rounded-xl bg-zinc-50 p-4 dark:bg-white/5">
          ...
          <div className="mt-1 text-sm text-zinc-700 dark:text-zinc-300">
            <a className="hover:underline" href={`/shop/${product.seller.id}`}>
